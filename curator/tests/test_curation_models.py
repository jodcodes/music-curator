...
def test_fav_playlist_name_uses_requested_format():
    assert fav_playlist_name("hiphop", TemperBucket.FROLIC) == "♥ Hip Hop & RnB"
    assert fav_playlist_name("electronic", TemperBucket.DREAD) == "♥ Electronic"
    assert fav_playlist_name("house", TemperBucket.DREAD) == "♥ House"
