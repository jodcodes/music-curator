# Domain Guides — MIGRATED

**This content has been integrated into OpenSpec specifications.**

For authoritative specifications with implementation context, see:

- [Metadata Enrichment](../../openspec/specs/metadata/spec.md)
- [Playlist Organization](../../openspec/specs/playlists/spec.md)
- [Temperament Analysis](../../openspec/specs/temperament/spec.md)
...
This information is now integrated directly into `openspec/specs/{domain}/spec.md` files.
```
